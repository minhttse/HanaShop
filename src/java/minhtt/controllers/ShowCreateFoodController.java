 ...
 * @author minhv
 */
public class ShowCreateFoodController extends HttpServlet {
    private final static String ERROR = "admin.jsp";
    private final static String SUCCESS = "createFood.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {           
            ...
            log("Error at ShowCreateFoodServlet "+e.toString());
        }
        finally{
