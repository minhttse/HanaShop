 ...
 * @author minhv
 */
public class UpdateAddressCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url=ERROR;
        try {
            String orderAddress=request.getParameter("txtOrderAddress");
            ...
            if(orderAddress.isEmpty()){
                ...
                cart.updateAddress(orderAddress);
                session.setAttribute("CART", cart);
                url = SUCCESS;
            }
        } catch (Exception e) {
            log("Error at UpdateAmountCartSerlvet: " + e.toString());
        }finally{
